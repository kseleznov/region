...
export const en = {
  ...
  profile: {
    ...
    myTips: {
      ...
      empty: "You haven't added any recommendations yet",
      edit: "Edit",
      editAria: "Edit recommendation for {name}",
      removeAria: "Remove recommendation for {name}",
    },
    editTipSheet: {
